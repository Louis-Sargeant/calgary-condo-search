...
final class Calgary_Condo_Area_Pages {
    ...
    private const REGIONAL_MRP_SHORTCODES = [
        ...
        'east-village-condos'          => '[mrp account_id=67196 listing_def=search-1440046 context=recip perm_attr=tmpl~v2][/mrp]',
        'eau-claire-condos'            => '[mrp account_id=67196 listing_def=search-1440047 context=recip perm_attr=tmpl~v2][/mrp]',
        'beltline-condos'              => '[mrp account_id=67196 listing_def=search-1440048 context=recip perm_attr=tmpl~v2][/mrp]',
        'mission-condos'               => '[mrp account_id=67196 listing_def=search-1440049 context=recip perm_attr=tmpl~v2][/mrp]',
        'hillhurst-condos'             => '[mrp account_id=67196 listing_def=search-1440050 context=recip perm_attr=tmpl~v2][/mrp]',
        'bridgeland-riverside-condos'  => '[mrp account_id=67196 listing_def=search-1440051 context=recip perm_attr=tmpl~v2][/mrp]',
        'inglewood-condos'             => '[mrp account_id=67196 listing_def=search-1440052 context=recip perm_attr=tmpl~v2][/mrp]',
        'sunnyside-condos'             => '[mrp account_id=67196 listing_def=search-1440053 context=recip perm_attr=tmpl~v2][/mrp]',
        'chinatown-condos'             => '[mrp account_id=67196 listing_def=search-1440054 context=recip perm_attr=tmpl~v2][/mrp]',
        'crescent-heights-condos'      => '[mrp account_id=67196 listing_def=search-1440055 context=recip perm_attr=tmpl~v2][/mrp]',
        'lower-mount-royal-condos'     => '[mrp account_id=67196 listing_def=search-1440056 context=recip perm_attr=tmpl~v2][/mrp]',
        'cliff-bungalow-condos'        => '[mrp account_id=67196 listing_def=search-1440057 context=recip perm_attr=tmpl~v2][/mrp]',
        'bankview-condos'              => '[mrp account_id=67196 listing_def=search-1440058 context=recip perm_attr=tmpl~v2][/mrp]',
        'erlton-condos'                => '[mrp account_id=67196 listing_def=search-1440059 context=recip perm_attr=tmpl~v2][/mrp]',
        'seton-condos'                 => '[mrp account_id=67196 listing_def=search-1440069 context=recip perm_attr=tmpl~v2][/mrp]',

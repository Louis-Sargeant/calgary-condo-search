...
final class Calgary_Condo_Market_Update_Page {
    ...
    private function styles(): string {
        return <<<'CSS'
<style>
.ccl-market-page{font-family:inherit;color:#fff;background:#07162a}.ccl-market-wrap{width:min(1180px,calc(100% - 40px));margin:0 auto}.ccl-market-hero{position:relative;overflow:hidden;background:#07162a;color:#fff;padding:76px 0 62px}.ccl-market-hero:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(7,22,42,.96),rgba(7,22,42,.78),rgba(7,22,42,.52)),url('https://images.unsplash.com/photo-1518005020951-eccb494ad742?auto=format&fit=crop&w=1800&q=80') center/cover;opacity:.94}.ccl-market-hero__inner{position:relative;display:grid;grid-template-columns:minmax(0,1fr) minmax(320px,.62fr);gap:38px;align-items:center}.ccl-market-eyebrow{display:inline-flex;align-items:center;gap:8px;margin:0 0 14px;color:#F0C75E;font-weight:900;letter-spacing:.12em;text-transform:uppercase;font-size:13px}.ccl-market-hero h1{margin:0 0 18px;font-size:clamp(40px,5.4vw,70px);line-height:.96;letter-spacing:-.05em;color:#fff}.ccl-market-hero p{font-size:18px;line-height:1.58;max-width:740px;color:rgba(255,255,255,.9);margin:0 0 28px}.ccl-market-actions{display:flex;flex-wrap:wrap;gap:14px}.ccl-market-btn{display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 22px;border-radius:14px;font-weight:900;text-decoration:none;box-shadow:0 18px 38px rgba(0,0,0,.18)}.ccl-market-btn--gold{background:#F0C75E;color:#0A1A2F}.ccl-market-btn--dark{background:#fff;color:#0A1A2F}.ccl-stat-panel{background:rgba(255,255,255,.11);border:1px solid rgba(255,255,255,.2);border-radius:28px;padding:26px;backdrop-filter:blur(10px)}.ccl-stat-panel h2{margin:0 0 14px;color:#fff;font-size:28px;line-height:1.1}.ccl-stat-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.ccl-stat-tile{border-radius:18px;background:rgba(255,255,255,.12);padding:16px}.ccl-stat-tile span{display:block;color:rgba(255,255,255,.72);font-size:12px;text-transform:uppercase;letter-spacing:.08em;font-weight:900}.ccl-stat-tile strong{display:block;color:#fff;font-size:28px;line-height:1.1;margin:7px 0}.ccl-stat-tile em{font-style:normal;color:#ffb4a8;font-weight:900}.ccl-stat-tile em.up{color:#a8f0c2}.ccl-market-section{padding:62px 0;background:#07162a}.ccl-market-section--soft{background:#0d1f3c}.ccl-market-section h2{margin:0 0 16px;font-size:clamp(30px,4vw,48px);line-height:1;letter-spacing:-.04em;color:#fff}.ccl-market-section p{font-size:17px;line-height:1.7;color:rgba(255,255,255,.82);max-width:850px}.ccl-data-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin-top:28px}.ccl-data-card{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:22px;padding:22px;backdrop-filter:blur(8px)}.ccl-data-card span{display:block;color:rgba(255,255,255,.75);font-size:12px;text-transform:uppercase;letter-spacing:.08em;font-weight:900}.ccl-data-card strong{display:block;margin:8px 0 4px;font-size:28px;letter-spacing:-.03em;color:#fff}.ccl-data-card em{font-style:normal;font-weight:900;color:#ffb4a8}.ccl-data-card em.up{color:#a8f0c2}.ccl-price-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:15px;margin-top:28px}.ccl-price-card{background:rgba(255,255,255,.08);border:1px solid rgba(240,199,94,.25);color:#fff;border-radius:22px;padding:20px;backdrop-filter:blur(8px)}.ccl-price-card span{display:block;color:#F0C75E;text-transform:uppercase;letter-spacing:.08em;font-size:12px;font-weight:900}.ccl-price-card strong{display:block;font-size:28px;margin:8px 0 4px}.ccl-price-card em{font-style:normal;color:#ffb4a8;font-weight:900}.ccl-price-card em.up{color:#a8f0c2}.ccl-area-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-top:26px}.ccl-area-card{border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.06);border-radius:20px;padding:18px;backdrop-filter:blur(8px)}.ccl-area-card span{display:block;color:rgba(255,255,255,.75);text-transform:uppercase;letter-spacing:.08em;font-size:12px;font-weight:900}.ccl-area-card strong{display:block;font-size:24px;margin:8px 0;color:#fff}.ccl-area-card em{font-style:normal;font-weight:900;color:#ffb4a8}.ccl-area-card em.up{color:#a8f0c2}.ccl-market-note{padding:18px 20px;border-left:5px solid #F0C75E;background:rgba(240,199,94,.08);border-radius:14px;color:rgba(255,255,255,.9);font-weight:800;margin-top:22px}.ccl-learn-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:20px;margin-top:32px}.ccl-learn-card{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:22px;padding:26px;backdrop-filter:blur(8px)}.ccl-learn-card h3{margin:0 0 10px;font-size:17px;letter-spacing:-.02em;color:#fff}.ccl-learn-card p{margin:0;font-size:15px;line-height:1.65;color:rgba(255,255,255,.78)}.ccl-market-cta-block{background:rgba(255,255,255,.06);border:1px solid rgba(240,199,94,.25);border-radius:28px;padding:52px 48px;text-align:center;margin-top:0}.ccl-market-cta-block p{color:rgba(255,255,255,.88);font-size:19px;line-height:1.6;max-width:640px;margin:0 auto 28px}.ccl-market-cta-btn{display:inline-flex;align-items:center;justify-content:center;min-height:52px;padding:0 32px;border-radius:14px;font-weight:900;font-size:16px;background:#F0C75E;color:#0A1A2F;border:none;cursor:pointer;box-shadow:0 18px 38px rgba(0,0,0,.18);text-decoration:none}@media(max-width:980px){.ccl-data-grid,.ccl-price-grid,.ccl-area-grid,.ccl-learn-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.ccl-market-hero__inner{grid-template-columns:1fr}.ccl-market-cta-block{padding:38px 24px}}@media(max-width:620px){.ccl-data-grid,.ccl-price-grid,.ccl-area-grid,.ccl-stat-grid,.ccl-learn-grid{grid-template-columns:1fr}.ccl-market-actions{display:grid}.ccl-market-btn{width:100%}}
</style>
CSS;
    }

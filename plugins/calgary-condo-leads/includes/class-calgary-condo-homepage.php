...
final class Calgary_Condo_Homepage {
    ...
    public function render(array $atts = [], ?string $content = null): string {
        ...
        <div class="ccl-home-tight ccl-home-search-first" data-ccl-condo-home>
            ...
            <?php
            $all_condos_url = '[ALL_CONDOS_URL]';
            $se_condos_url = '[SE_CONDOS_URL]';
            $sw_condos_url = '[SW_CONDOS_URL]';
            $nw_condos_url = '[NW_CONDOS_URL]';
            $ne_condos_url = '[NE_CONDOS_URL]';
            $downtown_url = '[DOWNTOWN_URL]';
            $beltline_url = '[BELTLINE_URL]';
            $under_400k_url = '[UNDER_400K_URL]';
            ?>

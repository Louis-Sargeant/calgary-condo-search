...
final class Calgary_Condo_Homepage {
    ...
    private function render_buyer_intent(): string {
        ...
        $cards = [
            ...
            ['title' => 'Top School Catchments', 'copy' => 'Filter active condo listings dynamically mapped to Calgary’s top-ranked designated public and separate school boundaries.', 'button' => 'Explore School Catchments', 'category' => 'Condo Alerts', 'icon' => '<span aria-hidden="true" style="font-size:2rem;line-height:1;">🎓</span>'],
            ['title' => 'Parks & Pet-Friendly Fields', 'copy' => 'Locate premium buildings within immediate walking distance to inner-city off-leash dog runs, pathways, and green spaces.', 'button' => 'Explore Pet-Friendly Areas', 'category' => 'Building Risk Report', 'icon' => '<span aria-hidden="true" style="font-size:2rem;line-height:1;">🌳</span>'],
        ];
        ob_start(); ?>

...
final class Calgary_Condo_Homepage {
    ...
    public function render(array $atts = [], ?string $content = null): string {
        ...
        $active_key = $this->active_search_key();
        $active_label = $this->active_search_label($active_key);
        $active_shortcode = $this->active_idx_shortcode($active_key);

        $tabs = [
            ['key' => 'all', 'label' => 'All Calgary Condos', 'url' => '/calgary-condos/#mrp-listings'],
            ['key' => 'southeast', 'label' => 'Southeast Calgary', 'url' => '/calgary-condos/?ccl_area=southeast#mrp-listings'],
            ['key' => 'southwest', 'label' => 'Southwest Calgary', 'url' => '/calgary-condos/#mrp-listings'],
            ['key' => 'northwest', 'label' => 'Northwest Calgary', 'url' => '/calgary-condos/#mrp-listings'],
            ['key' => 'northeast', 'label' => 'Northeast Calgary', 'url' => '/calgary-condos/#mrp-listings'],
            ['key' => 'downtown', 'label' => 'Downtown', 'url' => '/downtown-calgary-condos/'],
            ['key' => 'beltline', 'label' => 'Beltline', 'url' => '/beltline-condos/'],
            ['key' => 'under-400k', 'label' => 'Under $300K', 'url' => '/calgary-condos/?ccl_filter=under-400k#mrp-listings'],
            ['key' => 'price-drops', 'label' => 'Price Drops', 'url' => '/calgary-condos/?ccl_filter=price-drops#mrp-listings'],
            ['key' => 'open-houses', 'label' => 'Open Houses', 'url' => '/calgary-condos/#mrp-listings'],
        ];
                ...
                <div class="ccl-tight-hero__overlay">
                    <div class="ccl-wrap ccl-tight-hero__inner">
                        ...
                        <nav class="ccl-home-search ccl-home-search--links" aria-label="Calgary condo search shortcuts">
                            ...
                            <a href="/calgary-condos/?ccl_filter=under-400k#mrp-listings">Under $400K</a>
                        </nav>
                ...
                <div class="ccl-wrap">
                    ...
                    <nav class="ccl-home-tabs" aria-label="Calgary condo quick searches">
                        <?php foreach ($tabs as $tab) : ?>
                            <a class="<?php echo $active_key === $tab['key'] ? 'is-active' : ''; ?>" href="<?php echo esc_url($tab['url']); ?>"><?php echo esc_html($tab['label']); ?></a>
                        <?php endforeach; ?>
                    </nav>
                </div>
            </section>
    ...
    private function active_search_key(): string {
    ...
    private function active_idx_shortcode(string $key): string {
        return self::SEARCH_SHORTCODES[$key] ?? self::SEARCH_SHORTCODES['all'];
    }

    private function active_search_label(string $key): string {
        $labels = [

...
final class Calgary_Condo_Homepage {
    ...
    private function area_cards(): array {
        return [
            ...
            ['name' => 'Kensington', 'url' => '/hillhurst-condos/', 'title_url' => '/calgary-condo-buildings/kensington/', 'copy' => 'Boutique inner-city condo options around Sunnyside, Hillhurst, transit, and cafés.', 'filters' => 'inner-city,nw', 'photo' => 'https://images.unsplash.com/photo-1569880153113-76e33fc52d5f?auto=format&fit=crop&w=800&q=80'],
            ['name' => 'Bridgeland', 'url' => '/bridgeland-riverside-condos/', 'title_url' => '/calgary-condo-buildings/bridgeland/', 'copy' => 'Neighbourhood condo living with river access, local shops, and CTrain convenience.', 'filters' => 'inner-city,ne', 'photo' => 'https://images.unsplash.com/photo-1519501025264-65ba15a82390?auto=format&fit=crop&w=800&q=80'],

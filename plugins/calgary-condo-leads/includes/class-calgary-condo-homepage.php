...
final class Calgary_Condo_Homepage {
    ...
    private function area_cards(): array {
        return [
            ...
            ['name' => 'Hillhurst', 'url' => '/hillhurst-condos/', 'title_url' => '/calgary-condo-buildings/kensington/', 'copy' => 'Northwest inner-city condos close to Kensington Village, SAIT, transit, river pathways, and downtown access.', 'filters' => 'inner-city,nw', 'photo' => 'https://images.unsplash.com/photo-1569880153113-76e33fc52d5f?auto=format&fit=crop&w=800&q=80'],
            ...
            ['name' => 'Mahogany', 'url' => '/southeast-calgary-condos/', 'title_url' => '/calgary-condo-buildings/mahogany/', 'copy' => 'Lake-community condos with southeast lifestyle amenities and newer options.', 'filters' => 'se', 'photo' => 'https://images.unsplash.com/photo-1509909756405-be0199881695?auto=format&fit=crop&w=800&q=80'],
        ];
    }
    ...
    private function render_buyer_intent(): string {
        ...
        $cards = [
            ...
            ['title' => 'Top School Catchments', 'url' => '/top-school-catchments-2/', 'copy' => 'Filter active condo listings dynamically mapped to Calgary school boundaries.', 'micro' => 'Match your condo search to Calgary’s best school boundaries.'], 'micro' => 'Match your condo search to Calgary\'s best school zones.', 'button' => 'Explore School Catchments', 'url' => '/top-school-catchments-2/', 'category' => 'Condo Alerts', 'icon' => $school_icon],
            ['title' => 'Parks &amp; Pet-Friendly Areas', 'url' => '/calgary-pet-friendly-condos/', 'copy' => 'Locate premium buildings within immediate walking distance to inner-city off-leash dog runs, pathways, and green spaces.'],'micro' => 'Find off-leash parks and pathways walking distance from your condo.', 'button' => 'Explore Pet-Friendly Areas', 'url' => '/calgary-pet-friendly-condos/', 'category' => 'Building Risk Report', 'icon' => $park_icon],
        ];
        ob_start(); ?>

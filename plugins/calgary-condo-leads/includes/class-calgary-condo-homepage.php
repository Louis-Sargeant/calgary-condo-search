...
final class Calgary_Condo_Homepage {
    ...
    private function render_buyer_intent(): string {
        ...
        $value_icon  = '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 9.5 12 3l9 6.5V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9.5Z"/><path d="M9 21V13h6v8"/></svg>';
        ...
        $cards = [
            ['title' => 'Browse Calgary Condos', 'copy' => 'Search Calgary condo listings updated daily.', 'button' => 'Browse Listings →', 'url' => '/all-calgary-condos/', 'icon' => $search_icon],
            ['title' => 'Compare Condo Buildings', 'copy' => 'Compare buildings before you buy.', 'button' => 'Compare Buildings →', 'url' => '/calgary-condo-buildings/', 'icon' => $value_icon],
            ['title' => 'Top School Catchments', 'copy' => 'Explore Calgary\'s top school catchments.', 'button' => 'Explore Schools →', 'url' => '/calgary-communities/', 'icon' => $school_icon],
            ['title' => 'Parks &amp; Pet-Friendly Areas', 'copy' => 'Discover parks, pathways and pet-friendly communities.', 'button' => 'Explore Communities →', 'url' => '/calgary-communities/', 'icon' => $park_icon],
        ];
        ob_start(); ?>

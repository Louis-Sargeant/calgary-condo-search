...
final class Calgary_Condo_Homepage {
    ...
    private function render_buyer_intent(): string {
        ...
        $cards = [
            ...
            ['title' => 'Parks &amp; Pet-Friendly Areas', 'url' => '/calgary-pet-friendly-condos/', 'copy' => 'Locate premium buildings within immediate walking distance to inner-city off-leash dog runs, pathways, and green spaces.', 'micro' => 'Find off-leash parks and pathways walking distance from your condo.', 'button' => 'Explore Pet-Friendly Areas', 'icon' => $park_icon],
        ];
        ob_start(); ?>

...
final class Calgary_Condo_Lead_Modal {
    ...
    public function render_modal(): void {
        ...
        $success = isset($_GET['ccl_status']) && 'success' === sanitize_key(wp_unslash($_GET['ccl_status']));
        ?>
        <div id="ccl-unified-lead-modal" class="ccl-unified-lead-modal" aria-hidden="true">
            ...
            <div class="ccl-unified-lead-modal__panel" role="dialog" aria-modal="true" aria-labelledby="ccl-unified-lead-title">
                ...
                <?php if ($success) : ?>
                    <p class="ccl-unified-lead-modal__success" role="status"><?php esc_html_e('Thanks — your Calgary condo request was received.', 'calgary-condo-leads'); ?></p>
                <?php endif; ?>

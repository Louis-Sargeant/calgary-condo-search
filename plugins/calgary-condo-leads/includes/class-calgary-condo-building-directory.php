...
final class Calgary_Condo_Building_Directory {
    ...
    private const VISUAL_DIRECTORY_CARDS = [
        ...
        'Building Profile Searches' => [
            ['title' => 'Luxury High-Rise Condos', 'slug' => 'luxury-high-rise-condos', 'category' => 'Building Profile Searches', 'url' => '/luxury-high-rise-condos/', 'description' => 'Explore matching Calgary condo buildings by this profile.'],
            ['title' => 'Concrete Buildings', 'slug' => 'concrete-buildings', 'category' => 'Building Profile Searches', 'url' => '/concrete-buildings/', 'description' => 'Explore matching Calgary condo buildings by this profile.'],
            ['title' => 'Pet-Friendly Condo Buildings', 'slug' => 'pet-friendly-condo-buildings', 'category' => 'Building Profile Searches', 'url' => '/pet-friendly-condo-buildings/', 'description' => 'Explore matching Calgary condo buildings by this profile.'],
            ['title' => 'Buildings With Underground Parking', 'slug' => 'buildings-with-underground-parking', 'category' => 'Building Profile Searches', 'url' => '/buildings-with-underground-parking/', 'description' => 'Explore matching Calgary condo buildings by this profile.'],
            ['title' => 'Newer Condo Buildings', 'slug' => 'newer-condo-buildings', 'category' => 'Building Profile Searches', 'url' => '/newer-condo-buildings/', 'description' => 'Explore matching Calgary condo buildings by this profile.'],
            ['title' => 'Low-Rise Condo Buildings', 'slug' => 'low-rise-condo-buildings', 'category' => 'Building Profile Searches', 'url' => '/low-rise-condo-buildings/', 'description' => 'Explore matching Calgary condo buildings by this profile.'],
        ],
    ];
    ...
    private function render_visual_directory_card(array $item): string {
        $is_profile_card = 'Building Profile Searches' === $item['category'];
        $classes = 'ccl-visual-card ccl-visual-card--' . sanitize_html_class($item['slug']);
        if ($is_profile_card) {
            $classes .= ' ccl-visual-card--profile';
        }

        $description = $item['description'] ?? 'Browse current on-site Calgary condo options for this route.';
        $cta = $is_profile_card ? 'View Matching Buildings' : 'View Active Condos';

        return '<a href="' . esc_url($item['url']) . '" target="_self" class="' . esc_attr($classes) . '"><span class="ccl-visual-card__overlay"></span><span class="ccl-visual-card__category">' . esc_html($item['category']) . '</span><span class="ccl-visual-card__title">' . esc_html($item['title']) . '</span><span class="ccl-visual-card__description">' . esc_html($description) . '</span><span class="ccl-visual-card__cta">' . esc_html($cta) . '</span></a>';
    }
